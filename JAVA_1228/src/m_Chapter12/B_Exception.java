...
public class B_Exception {
	...
	public static void main(String[] args) {
		...
		try {
			FileReader file = new FileReader("C:\\eclipse -workspace\\JAVA_1228\\src\\m_Chapter12\\exception.txt");
		...
		// 오류 발생시
		try {
			FileReader file = new FileReader("C:\\eclipse -workspace\\JAVA_1228\\src\\m_Chapter12");
			BufferedReader bufferedReader = new BufferedReader(file);
