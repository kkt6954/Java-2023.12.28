...
//		: 프로그래밍에서 '같다'를 나타내는 기호 : ==(등호2개)를 사용
...
//			: _hello, $hello 가능(이름의 시작에 기호 가능)
//		- 카멜케이스를 사용
//			: 시작 단어는 소문자로 시작, 이어지는 단어는 대문자로 시작
//			: student name > studentName / score total > scoreTotal
//		- 전체 대문자 사용을 지양
//			: 상수와 구분하기 위함(상수명명 규칙은 대문자 사용)
