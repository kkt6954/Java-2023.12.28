...
// 2. 데이터 삽입 / 삭제에 효율적
// 장점 : 특정 위치에서의 요소 추가 / 삭제가 빠름
// 단점 : 특정 위치의 요소에 접근하는 것은 리스트를 순회해야하기 떄문에 속도가 비교적 느림
// 3. 널(Null)값을 허용
...
public class B_List {
	...
	public static void main(String[] args) {
		...
		// 특정 위치의 요소를 수정
		System.out.println(linkedList.set(1, "Orange")); // Banana >> Orange
		...
		System.out.println(linkedList.contains(fruitElement)); // false
