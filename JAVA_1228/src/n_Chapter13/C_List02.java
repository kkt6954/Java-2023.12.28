...
// 1. get, remove, set 메서드(index를 사용하는 메서드)의 경우
// 인덱스가 유효한지 확인을 한 후 사용
// >> 유효하지 않은 인덱스 사용시 IndexOutOfBounds 예외 발생

// 2. contains(Object o)메서드 사용시
// : 리스트에 지정된 요소가 있는지 검사 필요
...
public class C_List02 {
	...
	public static void main(String[] args) {
		...
		// - 요소를 추가, 삭제하는 것은 빠름 / 요소를 읽는 것은 느림
		
		// 2. 저장 구조 & 검색
		
		// ArrayList
		// - 요소의 추가 및 삭제시 요소를 이동시켜야함.
		// - 인덱스를 통한 접근을 사용 - 빠름
		// 예시) 도서관 책장
		// 책의 번호를 아는 경우 해당 책장에서 책을 빠르게 가져올 수 있다.
		...
		// 책의 기록을 찾을려면 특정 날짜의 대출 기록에 접근해서 하나씩 기록을 읽어야 함. - 시간이 오래걸림
	}
