...
// - 학습 곡선이 높음 : 이해하고 사용하기까지 일정한 학습필요

//! MVC 패턴의 작동 원리
// V > C > M > C > V
// 사용자 인터랙션(상호작용) : 뷰를 통해 상호작용
// 컨트롤러 처리 : 사용자의 행동이 컨트롤러로 전달
// 모델 업데이트 : 컨트롤러는 모델을 업데이트 하거나 조회하여 필요한 데이터를 받음
// 뷰 업데이트 : 컨트롤러는 새로운 데이터와 함께 업데이트를 하라고 지시
// 사용자에게 표시 : 뷰는 업데이트된 데이터를 표시

// Spring
// , SpringBoot(SpringMVC을 포함)
// : 자바 기반 통합 웹개발 프레임워크
