...
public class F_ArrayList01 {
	...
	public static void main(String[] args) {
		...
		// : int(Integer), char(Character), boolean(Boolean), String
		
		// ArrayList 생성
		// ArrayList<데이터타입> 배열명 = new ArrayList<>();
													  // 유동적이라서 선택적 크기 지정을 해도 되고 안해도 됨
		ArrayList<Integer> arrayList = new ArrayList<>();
		
		// ArrayList에 데이터 추가
		// : 해당 리스트(배열)의 가장 끝에 값을 추가
		// 배열명.add(추가할 데이터 작성);
		arrayList.add(1); // 인덱스 번호 0
		arrayList.add(2); // 인덱스 번호 1
		arrayList.add(3); // 인덱스 번호 2 
